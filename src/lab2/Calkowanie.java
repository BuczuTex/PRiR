...
public class Calkowanie {
    ...
    public static void main(String[] args) {
        ...
        in.nextLine();
        System.out.println("Podaj przedzial calkowania w formie: lewyKoniec:prawyKoniec ");
        ...
        System.out.println("Wynik w metodzie trapezow: "+ wynik);
        wynikPr += M_prostokatow.function(a + dokladnosc * h) * h;
        System.out.println("Wynik w metodzie prostokatow: "+ wynikPr);
        //Metoda Simpsona
